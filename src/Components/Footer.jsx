    ...
    <div className="container mt-5">
      <div className="row">
        <div className="col-md-6 mb-4">
         <div>
         <div className="text-green-900 font-serif font-extrabold display-4 text-blue ">JobPortal.lk</div>
          <div className="text-gray-400 mt-2">
          Post Jobs for Free with JobPortal.lk Candidates Submit your CV and be contacted by Employers. Search Jobs all across Sri Lanka and apply online.
          </div>
         </div>
          <div className=' mt-4'>
          <div>Follow US</div>
