    ...
    <div className='row  my-5 d-flex  align-items-center'>
      ...
      <div className='col-md-6 pt-5'>
        <div className='p-4'>
          ...
          <p>
            Embark on your career journey with JobPortal, your go-to destination for seamless online job applications.
            ...
            showcase your talents or discover your ideal workforce. At  JobPortal, we believe in efficiency,
            transparency, and the transformative power of connections. Your path to professional success starts right here,
            where applying for jobs online becomes a breeze. Join us at  JobPortal, where careers take flight.
          </p>
        </div>
      </div>
    </div>
